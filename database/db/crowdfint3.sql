...
-- Tiempo de generación: 13-02-2020 a las 13:52:01
...
(30, 5, 'Proyectos', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-02 21:35:40', '2020-01-02 21:35:40', 'posts.index', NULL),
(32, 6, 'Tablero', '', '_self', 'fas fa-tachometer-alt', NULL, NULL, 1, '2020-01-07 17:37:24', '2020-01-07 17:37:24', 'home', NULL),
(33, 3, 'Proyectos', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-07 17:37:24', '2020-01-07 17:37:24', 'posts.index', NULL),
(34, 7, 'Tablero', '', '_self', 'fas fa-tachometer-alt', NULL, NULL, 1, '2020-01-11 02:51:15', '2020-01-11 02:51:15', 'home', NULL),
(35, 7, 'Proyectos', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-11 02:51:15', '2020-01-11 02:51:15', 'posts.index', NULL),
...
(50, 15, 'Tablero', '', '_self', 'fas fa-tachometer-alt', NULL, NULL, 1, '2020-01-23 22:54:05', '2020-01-23 22:54:05', 'home', NULL),
(51, 15, 'Mostrar Publicaciones', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-23 22:54:05', '2020-01-23 22:54:05', 'posts.index', NULL),
(52, 16, 'Tablero', '', '_self', 'fas fa-tachometer-alt', NULL, NULL, 1, '2020-01-26 15:24:07', '2020-01-26 15:24:07', 'home', NULL),
(53, 16, 'Mostrar Publicaciones', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-26 15:24:07', '2020-01-26 15:24:07', 'posts.index', NULL),
(54, 5, 'Mi Actividad\r\n', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-02 21:35:40', '2020-01-02 21:35:40', 'miactividad', NULL),
(55, 17, 'Tablero', '', '_self', 'fas fa-tachometer-alt', NULL, NULL, 1, '2020-01-28 19:38:17', '2020-01-28 19:38:17', 'home', NULL),
(56, 17, 'Mostrar Publicaciones', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-28 19:38:17', '2020-01-28 19:38:17', 'posts.index', NULL),
(57, 18, 'Tablero', '', '_self', 'fas fa-tachometer-alt', NULL, NULL, 1, '2020-01-30 00:27:46', '2020-01-30 00:27:46', 'home', NULL),
(58, 18, 'Mostrar Publicaciones', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-30 00:27:46', '2020-01-30 00:27:46', 'posts.index', NULL),
(59, 18, 'Mi Actividad', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-30 00:27:46', '2020-01-30 00:27:46', 'miactividad', NULL),
(60, 19, 'Tablero', '', '_self', 'fas fa-tachometer-alt', NULL, NULL, 1, '2020-01-30 00:46:49', '2020-01-30 00:46:49', 'home', NULL),
(61, 19, 'Proyectos', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-30 00:46:49', '2020-01-30 00:46:49', 'posts.index', NULL),
(62, 19, 'Mi Actividad', '', '_self', 'fas fa-newspaper', NULL, NULL, 2, '2020-01-30 00:46:49', '2020-01-30 00:46:49', 'home.miactividad', NULL);
...
(1, 2, 'dashboard.view', 'Tablero', 'web', 0, '2019-12-30 23:34:40', '2020-01-28 18:29:25'),
...
(22, 6, 'posts.list', 'Mostrar Publicaciones', 'web', 0, '2019-12-30 23:34:41', '2020-01-30 20:39:41'),
...
(38, 6, 'posts.registro_financiero', 'registra datos financieros del usuario', 'web', 0, '2020-01-11 03:00:00', '2020-02-12 23:55:42'),
(39, 6, 'posts.registro_financiero_guardar', 'registro_financiero_guardar', 'web', 0, '2020-01-14 20:07:14', '2020-01-14 20:08:54'),
(40, 2, 'home.misinversiones', 'Listado de inversiones en proyectos activos del usuario', 'web', 0, '2020-01-25 03:00:00', '2020-01-28 18:29:25'),
(41, 2, 'home.miactividad', 'Mi Actividad', 'web', 0, '2020-01-27 16:28:23', '2020-01-29 23:09:14');
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `resumen` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `porcentaje` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meses` int(11) DEFAULT NULL,
  `ubicacion` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `retorno_anual` int(11) DEFAULT NULL,
  `retorno_total` int(11) DEFAULT NULL,
  `duracion_meses` int(11) DEFAULT NULL,
  `rendimiento_total` int(11) DEFAULT NULL,
...
INSERT INTO `posts` (`id`, `title`, `subtitle`, `resumen`, `slug`, `body`, `status`, `posted_by`, `image`, `created_at`, `updated_at`, `porcentaje`, `meses`, `ubicacion`, `retorno_anual`, `retorno_total`, `duracion_meses`, `rendimiento_total`, `fecha_inicio`, `fecha_finalizacion`, `image2`, `image3`) VALUES
(1, 'NEXT PAMPA', 'RENTABILIDAD EN DOLARES', NULL, 'ALQUILER TEMPORARIO', '<p><em>Se propone adquirir un\r\nporcentaje del proyecto\r\nparticipando como dueño del\r\nnegocio en la explotación de\r\nlas oficinas, el cual genera un\r\nretorno anual estimado del 5%\r\nsobre el capital invertido, al\r\nque se le suma la\r\nrevalorización del edificio con\r\nsu posterior venta.\r\nLa administradora es una\r\nempresa líder en Real Estate\r\nde Estados que busca\r\ndesarrollar un xxxxxxxxxxxxxx\r\nxxxxxxxxxxxxxxxx xxxxxxxxxx.\r\nLa plataforma Crowdfint actua\r\nde intermediario entre el\r\ninversor y la administradora del\r\nproyecto.</p>', 1, 1, 'pampa.jpg', '2020-01-02 23:00:00', '2020-01-02 23:02:16', '20- 30', 36, '', NULL, NULL, NULL, NULL, NULL, NULL, '', ''),
(2, 'ALTOS DE AÑELO ', 'RENTABILIDAD EN DOLARES', NULL, 'ALQUILER TEMPORARIO', '36 MESES', 0, 1, 'yYkFqmGCG7qv0CBu8gv0ZWKGyB7JTcpRA1Q2ixem.jpeg', NULL, NULL, '22- 32', 24, '', NULL, NULL, NULL, NULL, NULL, NULL, '', ''),
(3, 'NEXT BUSTAMANTE', 'RENTABILIDAD EN DOLARES', NULL, 'DESARROLLO DEL POZO', '<p><em>Proyecto escrito y publicado por Agropecuaria Surmax S.A.</em></p>\r\n\r\n<p>SeSocio en la producci&oacute;n y comercializaci&oacute;n de ganado bovino a corral. Obten&eacute;&nbsp;una rentabilidad anual en d&oacute;lares del 14% fijo, con pago semestral. El capital invertido va a destinarse a la compra de terneros para ser engordados dentro de un corral cerrado y posteriormente lo venderemos el mismo en el mercado interno. El proyecto dura 1 a&ntilde;o, y se pagan los intereses de manera semestral.</p>', 1, 1, 'bustamante.jpg', '2020-01-02 23:00:00', '2020-01-02 23:02:16', '25- 35', 36, '', NULL, NULL, NULL, NULL, NULL, NULL, '', ''),
(9, 'ESTANCCIA VILLA MARIA', 'RENTABILIDAD EN DOLARES', NULL, 'ALQUILER TEMPORARIO', '<p><em>Proyecto escrito y publicado por Agropecuaria Surmax S.A.</em></p>\r\n\r\n<p>SeSocio en la producci&oacute;n y comercializaci&oacute;n de ganado bovino a corral. Obten&eacute;&nbsp;una rentabilidad anual en d&oacute;lares del 14% fijo, con pago semestral. El capital invertido va a destinarse a la compra de terneros para ser engordados dentro de un corral cerrado y posteriormente lo venderemos el mismo en el mercado interno. El proyecto dura 1 a&ntilde;o, y se pagan los intereses de manera semestral.</p>', 1, 1, 'estancia.jpg', '2020-01-02 23:00:00', '2020-01-02 23:02:16', '30- 40', 36, '', NULL, NULL, NULL, NULL, NULL, NULL, '', ''),
(10, 'ALTOS DE AÑELO III', 'RENTABILIDAD EN DOLARES', NULL, 'ALQUILER TEMPORARIO', 'Se propone adquirir un\r\nporcentaje del proyecto\r\nparticipando como dueño del\r\nnegocio en la explotación de\r\nlas oficinas, el cual genera un\r\nretorno anual estimado del 5%\r\nsobre el capital invertido, al\r\nque se le suma la\r\nrevalorización del edificio con\r\nsu posterior venta.\r\nLa administradora es una\r\nempresa líder en Real Estate\r\nde Estados que busca\r\ndesarrollar un xxxxxxxxxxxxxx\r\nxxxxxxxxxxxxxxxx xxxxxxxxxx.\r\nLa plataforma Crowdfint actua\r\nde intermediario entre el\r\ninversor y la administradora del\r\nproyecto.', 0, 1, 'yYkFqmGCG7qv0CBu8gv0ZWKGyB7JTcpRA1Q2ixem.jpeg', NULL, NULL, '25 - 35', 24, '', NULL, NULL, NULL, NULL, NULL, NULL, '', ''),
(11, 'NEXT BUSTAMANTE II', 'RENTABILIDAD EN DOLARES', NULL, 'DESARROLLO DEL POZO', '<p><em>Proyecto escrito y publicado por Agropecuaria Surmax S.A.</em></p>\r\n\r\n<p>SeSocio en la producci&oacute;n y comercializaci&oacute;n de ganado bovino a corral. Obten&eacute;&nbsp;una rentabilidad anual en d&oacute;lares del 14% fijo, con pago semestral. El capital invertido va a destinarse a la compra de terneros para ser engordados dentro de un corral cerrado y posteriormente lo venderemos el mismo en el mercado interno. El proyecto dura 1 a&ntilde;o, y se pagan los intereses de manera semestral.</p>', 1, 1, 'bustamante2.jpg', '2020-01-02 23:00:00', '2020-01-02 23:02:16', '25 - 35', 36, '', NULL, NULL, NULL, NULL, NULL, NULL, '', ''),
(13, 'Prueba de titulo', 'subtitulo de prueba', NULL, 'slug prueba', '<p>texto de prueba cuerpo del proyecto</p>', NULL, 1, 'images/posts/fGyfGASzNRmwlM8e3Df0E3kylF8Wv6eKKZlTpcw3.jpeg', '2020-01-31 21:57:46', '2020-01-31 21:57:46', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(4, 'Extraccion', 'por PayPal o Cuenta Bancaria'),
...
(1, 'Administrador', 'admin@gmail.com', 'administrator', NULL, '$2y$10$mMYzfC8A98aXecS91ZeAW.GrWtCgCmU/F3iiAquKjL838WRvfoXEq', 't1Wn31jt3oCVx873UwmmDkkQRx86cF16gmsTNaZDRxe2tjV5OSTY8dJIDmrb', '2019-12-30 23:34:41', '2019-12-30 23:34:41', '', NULL, NULL, NULL, NULL, '', '', 0, '', 0, 1, '0000-00-00'),
...
(5, 'rolandodel', 'rolandodel@gmail.com', 'rolandodel', NULL, '$2y$10$qGxRSqKryfpcMI4XAgsvGeADIV1H18PajHqGEOyC7jkcyT2gxxAQm', 'Zrg66Bh4VuugocEjqcplHQzkkISdB1btM9FJYdyIby4UJoEtHwDC0S1KL9mz', '2020-01-02 21:35:40', '2020-01-14 20:08:32', '', NULL, NULL, NULL, NULL, '', '', 0, '', 0, 1, '0000-00-00'),
...
--
-- Volcado de datos para la tabla `user_movimientos`
--

INSERT INTO `user_movimientos` (`id_movimientos`, `id_user`, `id_tipo_movimiento`, `fecha_movimiento`, `monto_usd`, `detalle_movimiento`, `estado_movimiento`) VALUES
(1, 5, 4, '2020-01-23', 50, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `user_proyecto_invertido`
--

DROP TABLE IF EXISTS `user_proyecto_invertido`;
CREATE TABLE IF NOT EXISTS `user_proyecto_invertido` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_user` int(11) NOT NULL,
  `id_post` int(11) NOT NULL,
  `dinero_invertido` float NOT NULL,
  `fecha_inversion` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `user_proyecto_invertido`
--

INSERT INTO `user_proyecto_invertido` (`id`, `id_user`, `id_post`, `dinero_invertido`, `fecha_inversion`) VALUES
(1, 5, 1, 2000, '2020-01-23');
...
CREATE TABLE IF NOT EXISTS `user_saldos` (
  ...
  `saldo_dolar` float DEFAULT NULL,
  `disponible` float DEFAULT NULL,
  `saldo_invertido` float DEFAULT NULL,
  PRIMARY KEY (`id_saldos`),
  UNIQUE KEY `id_saldos` (`id_saldos`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `user_saldos`
--

INSERT INTO `user_saldos` (`id_saldos`, `id_user`, `fecha_saldo`, `saldo_dolar`, `disponible`, `saldo_invertido`) VALUES
(1, 5, '2020-01-21', 200, 50, 2000);
COMMIT;
